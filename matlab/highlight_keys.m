...
if iFrame>1  
    if length(whichkeys)>0 
        if whichkeys(1)>0 
            for i=whichkeys(1,:);
                line([whitekeyinitial{i,1}(1),whitekeyinitial{i,2}(1)],[whitekeyinitial{i,1}(2), whitekeyinitial{i,2}(2)],'Color','g','LineWidth',2)
                line([whitekeyinitial{i,2}(1),whitekeyinitial{i,3}(1)],[whitekeyinitial{i,2}(2), whitekeyinitial{i,3}(2)],'Color','g','LineWidth',2)
                line([whitekeyinitial{i,3}(1),whitekeyinitial{i,4}(1)],[whitekeyinitial{i,3}(2), whitekeyinitial{i,4}(2)],'Color','g','LineWidth',2)
                line([whitekeyinitial{i,4}(1),whitekeyinitial{i,1}(1)],[whitekeyinitial{i,4}(2), whitekeyinitial{i,1}(2)],'Color','g','LineWidth',2)
%                  pause(0.2);
            end
        end
    end
